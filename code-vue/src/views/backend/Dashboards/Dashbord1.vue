                     ...
                     <div class="d-flex justify-content-between align-items-center">
                        <div>
                           <svg width="24" height="24" viewBox="0 0 24 24" fill="primary" xmlns="http://www.w3.org/2000/svg">
                              <rect id="Rectangle 79" x="3" y="3" width="18" height="18" rx="2" fill="#3378FF"/>
                           </svg> 
                           <span>Incomes</span>
                        </div>
                        <div class="ml-3">
                           <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <rect id="Rectangle 79" x="3" y="3" width="18" height="18" rx="2" fill="#19b3b3"/>
                           </svg> 
                           <span>Expenses</span>
                        </div>
                     </div>
                  </div>
                  <div id="chart-apex-column-01" class="custom-chart">
                       <ApexChart element="dash-chart-1" :chartOption="chart1" />
                  </div>
                </div>
            </div>   
            </div>
                   ...
                   <div class="card-body">
                       <div class="d-flex align-items-center">
                           <div class="fit-icon-2 text-info text-center">
                              <div>
                                 <CircleProgress :value="62" color="light" /> 
                              </div>
                           </div>
                           <div class="ml-3">
            ...
            <div class="col-md-12">
               <div class="card">
                  <div class="card-body" style="position: relative;">
                     ...
                     <div><p class="mb-0">Pages views per day</p></div>
                     <div id="chart-apex-column-02" class="custom-chart" style="min-height: 183px;">
                          <ApexChart element="dash-chart-2" :chartOption="chart2" />   
                     </div>
                     <div class="d-flex justify-content-between align-items-center">
	...
	<div class="col-lg-4 col-md-6">
         <div class="card">
            <div class="card-body">
               ...
               <div id="chart-apex-column-03" class="custom-chart">
                  <ApexChart element="dash-chart-3" :chartOption="chart3" />
               </div>
               <div class="d-flex justify-content-around align-items-center">
                  <div>
                     <svg width="24" height="24" viewBox="0 0 24 24" fill="#ffbb33" xmlns="http://www.w3.org/2000/svg">
                        <rect id="Rectangle 79" x="3" y="3" width="18" height="18" rx="2" fill="#ffbb33"/>
                     </svg> 
                     <span>Mobile</span>
                  </div>
                  <div>
                     <svg width="24" height="24" viewBox="0 0 24 24" fill="#e60000" xmlns="http://www.w3.org/2000/svg">
                        <rect id="Rectangle 79" x="3" y="3" width="18" height="18" rx="2" fill="#e60000"/>
                     </svg>    
                     <span>Laptop</span>
                  </div>
               </div>
               <div class="d-flex justify-content-around align-items-center mt-3">
                  <div>
                     <svg width="24" height="24" viewBox="0 0 24 24" fill="primary" xmlns="http://www.w3.org/2000/svg">
                        <rect id="Rectangle 79" x="3" y="3" width="18" height="18" rx="2" fill="#04237D"/>
                     </svg>
                     <span>Electronics</span>
                  </div>
                  <div><i class="fas fa-stop mr-1 ml-2" style="color: #8080ff;"></i>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="primary" xmlns="http://www.w3.org/2000/svg">
                        <rect id="Rectangle 79" x="3" y="3" width="18" height="18" rx="2" fill="#8080ff"/>
                        </svg>
                     <span>Others</span>
                  </div>
               </div>
                              ...
                              <p class="mb-0 text-success d-flex justify-content-start align-items-center">
                                 <small>
                                    <svg class="mr-2" xmlns="http://www.w3.org/2000/svg" width="18" viewBox="0 0 24 24" fill="none">                                                
                                       <circle id="Ellipse 65" cx="12" cy="12" r="8" fill="#3cb72c"></circle>
                                    </svg>
                                 </small>Completed
                              </p>
                           </td>
      ...
      <div class="col-lg-4 col-md-12">
         <div class="card">
            <div class="card-body">
               ...
               <div id="chart-map-column-04" style="position: relative;" class="custom-chart custom-chart leaflet-container leaflet-touch leaflet-retina leaflet-fade-anim leaflet-grab leaflet-touch-drag leaflet-touch-zoom">
                     <!-- <ApexChart element="dash-chart-4" :chartOption="chart4" /> -->
                     <l-map ref="myMap" @ready="mapoption()"> </l-map>
               </div>
            </div>
         </div>
      </div>
...
import CircleProgress from '../../../components/progressbar/Circleprogressbar'
