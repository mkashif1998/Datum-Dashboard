    ...
    <div class="container-fluid">
        ...
        <div class="row">    
            <div class="col-lg-12 mb-3 d-flex justify-content-between">
                <h4 class="font-weight-bold d-flex align-items-center">Add New Customer</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <form class="row g-3 date-icon-set-modal">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="tt" class="form-label font-weight-bold text-muted text-uppercase">Gender</label><br>
                                    ...
                                    <div class="col-md-6 mb-3 position-relative">
                                        ...
                                        <input type="text" class="form-control vanila-datepicker" id="Text2" name="event_date" placeholder="Enter Birth Day" autocomplete="off" aria-describedby="basic-addon2">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <label for="Text" class="form-label font-weight-bold text-muted text-uppercase mb-3">Notification Type</label><br>
                                        <div class="form-check form-check-inline">
