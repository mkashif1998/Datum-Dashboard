                        ...
                        <a href="#">
                           <i class="fab fa-facebook-f">
                              <svg width="24" height="24" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <g id="023-facebook" clip-path="url(#clip0)">
                                    <path id="Vector" d="M341.269 85.0133H388.011V3.60533C379.947 2.496 352.213 0 319.915 0C252.523 0 206.357 42.3893 206.357 120.299V192H131.989V283.008H206.357V512H297.536V283.029H368.896L380.224 192.021H297.515V129.323C297.536 103.019 304.619 85.0133 341.269 85.0133V85.0133Z" fill="black"/>
                                 </g>
                                 <defs>
                                    <clipPath id="clip0"><rect width="512" height="512" fill="white"/></clipPath>
                                 </defs>
                              </svg>
                           </i>
                        </a>
         ...
         <div class="card card-block">
            ...
            <div class="card-body">
               ...
               <div class="iq-progress-bar-linear d-inline-block w-100 mb-3">
                  ...
                  <Progressbar :value="90" midclass="iq-progress-bar" color="primary" class="iq-progress-bar pro-skill"/>
               </div>
               <div class="iq-progress-bar-linear d-inline-block w-100 mb-3">
                  <span>MySQl</span>
                  <span class="float-right">85%</span>
                  <Progressbar :value="85" midclass="iq-progress-bar" color="danger" class="iq-progress-bar pro-skill"/>
               </div>
               <div class="iq-progress-bar-linear d-inline-block w-100 mb-3">
                  <span>Node Js</span>
                  <span class="float-right">70%</span>
                  <Progressbar :value="70" midclass="iq-progress-bar" color="warning" class="iq-progress-bar pro-skill"/>
               </div>
               <div class="iq-progress-bar-linear d-inline-block w-100">
                  <span>Angular Js</span>
                  <span class="float-right">55%</span>
                  <Progressbar :value="55" midclass="iq-progress-bar" color="info" class="iq-progress-bar pro-skill"/>
               </div>
            </div>
         </div>
         <div class="card card-block">
