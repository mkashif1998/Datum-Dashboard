<template>
	...
	<div class="iq-navbar-custom">
		<nav class="navbar navbar-expand-lg navbar-light p-0">
			...
			<div class="side-menu-bt-sidebar">
                <svg xmlns="http://www.w3.org/2000/svg" class="text-secondary wrapper-menu" width="30" fill="none" viewBox="0 0 24 24" stroke="currentColor" @click="miniSidebar">
 ...
 <li class="nav-item nav-icon dropdown"  v-nav-toggle> 
                                                 ...
                                                 <div class="list-item d-flex justify-content-start align-items-start">
                                                     <div class="avatar">
                                                        <div class="avatar-img avatar-success avatar-20">
                                                            <span><img class="avatar is-squared rounded-circle" src="@/assets/images/user/2.jpg"></span>
                                                        </div>
                                                    </div>
                                                    <div class="list-style-detail ml-2 mr-2">
                        ...
                        <li class="nav-item nav-icon dropdown" v-nav-toggle>
                            ...
                            {{!-- <img src="../assets/images/Flag/flag001.png"  alt="img-flaf" class="img-fluid mr-1" style="height: 16px; width: 16px;" /> --}} -->
