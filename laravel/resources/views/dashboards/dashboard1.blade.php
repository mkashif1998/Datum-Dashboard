                            ...
                            <table class="table mb-0">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-45 mr-2">
                                                <img src="{{asset('images/user/2.jpg')}}" class="img-fluid rounded-circle"
                                                     alt="image">
                                            </div>
                                ...
                                <tr class="white-space-no-wrap">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-45 mr-2">
                                                <img src="{{asset('images/user/5.jpg')}}" class="img-fluid rounded-circle"
                                                     alt="image">
                                            </div>
                                ...
                                <tr class="white-space-no-wrap">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-45 mr-2">
                                                <img src="{{asset('images/user/1.jpg')}}" class="img-fluid rounded-circle"
                                                     alt="image">
                                            </div>
                                            <div>Max Lynn</div>
                                        </div>
                                ...
                                <tr class="white-space-no-wrap">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-45 mr-2">
                                                <img src="{{asset('images/user/3.jpg')}}" class="img-fluid rounded-circle"
                                                     alt="image">
                                            </div>
                                            <div>Danniw Yatt</div>
                                        </div>
