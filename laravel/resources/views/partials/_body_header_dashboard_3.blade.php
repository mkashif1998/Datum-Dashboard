    ...
    <div class="iq-navbar-custom d-flex align-items-center justify-content-between">
        <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
            ...
            <a href="{{ route('dashboard.1') }}" class="header-logo">
                ...
                <img src="{{asset('images/white-logo.png')}}" class="img-fluid rounded-normal darkmode-logo"
                    alt="logo">
            </a>
        </div>
            ...
            <nav class="iq-sidebar-menu">
                <div class="iq-sidebar-logo d-flex align-items-center justify-content-between">
                    ...
                    <div class="side-menu-bt-sidebar">
                        <i class="las la-bars wrapper-menu mr-0"></i>
                    </div>
                </div>
                <ul id="iq-sidebar-toggle" class="side-menu d-flex">
                    <li class="active">
                        <a href="#Dashboards" class="collapsed" data-toggle="collapse" aria-expanded="false">
                            <svg class="svg-icon text-primary" id="iq-dash" xmlns="http://www.w3.org/2000/svg"
                                width="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                    ...
                    <li class=" ">
                        <a href="#ui" class="collapsed" data-toggle="collapse" aria-expanded="false">
                            <svg class="svg-icon text-primary" id="iq-ui-1" xmlns="http://www.w3.org/2000/svg"
                                width="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        ...
                        <ul id="ui" class="iq-submenu sub-scrll collapse" data-parent="#iq-sidebar-toggle">
                            ...
                            <li class=" ">
                                <a href="{{ route('ui.colors') }}html" class="svg-icon">
                                    <i class="">
                    ...
                    <li class=" ">
                        <a href="#auth" class="collapsed" data-toggle="collapse" aria-expanded="false">
                            <svg class="svg-icon text-primary" id="iq-auth-1" width="20"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <ul class="navbar-nav ml-auto navbar-list align-items-center">
                    ...
                    <li class="nav-item nav-icon dropdown">
                        <a href="#" class="search-toggle dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false">
                            <svg class="svg-icon text-primary" id="iq-bell-2" xmlns="http://www.w3.org/2000/svg"
                                width="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                    ...
                    <li class="nav-item full-screen d-none d-lg-block">
                    ...
                    <li class="nav-item nav-icon dropdown">
                        <a href="#" class="nav-item nav-icon dropdown-toggle search-toggle pr-2" id="dropdownMenuButton"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
